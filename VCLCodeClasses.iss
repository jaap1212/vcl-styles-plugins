...
[Setup]
AllowNoIcons=yes
AppName=VCL Codeclasses
AppVersion=1.5
DefaultDirName={autopf}\VCL Codeclasses
DefaultGroupName=VCL Codeclasses
DisableWelcomePage=no
Compression=lzma2/Ultra64
SolidCompression=yes
OutputDir=userdocs:Inno Setup Examples Output
OutputBaseFilename=VCL Codeclasses
...
[Icons]
Name: "{group}\VCL Codeclasses"; Filename: "{app}\MyProg.exe"
Name: "{group}\{cm:UninstallProgram,}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\VCL Codeclasses"; Filename: "{app}\MyProg.exe"; Tasks: desktopicon
